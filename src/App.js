      ...
      <Router>
        <Switch>
          <Route
            ...
            path="/:lang/checkout"
            render={(props) => (
              <Checkout isAuthenticated={isAuthenticated} {...props} />
            )}
          />
          <Route
            exact
          ...
          <Route
            ...
            path="/:lang/cart"
            render={(props) => (
              <Cart isAuthenticated={isAuthenticated} {...props} />
            )}
          />
          <Route
            exact
          ...
          <Route
            ...
            render={(props) => (
              <Profile isAuthenticated={isAuthenticated} {...props} />
            )}
          />
          <Route
            render={(props) => (
              <DefaultContainer isAuthenticated={isAuthenticated} />
            )}
          />
        </Switch>
      </Router>
